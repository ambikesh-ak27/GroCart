...
import static com.example.grocart.AllCategoriesDialog.ALL_CATEGORIES;
import static com.example.grocart.AllCategoriesDialog.CALLING_ACTIVITY;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.cart){
                    ...
                    new AlertDialog.Builder(MainActivity.this)
                            .setTitle("About Us")
                            .setMessage("Designed and Developed by Ambikesh at ambikesh-ak27/github.com\n" +
                                    "Visit for More")
                    ...
                    new AlertDialog.Builder(MainActivity.this)
                            .setTitle("Terms")
                            .setMessage("There are no terms, Ennjoy Using the application :)")
